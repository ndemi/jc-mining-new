...
Config.IceDrill = {
    ...
    prompt = 'Press [E] to drill for ice', -- Text UI prompt shown to players when ox_target is unavailable
    ...
    useTarget = true, -- Use ox_target for drill interactions when available
    targetIcon = 'fa-solid fa-icicles', -- Icon displayed in the ox_target context menu
    targetLabel = 'Drill for ice', -- Label displayed in the ox_target context menu
    zones = { -- PolyZone areas where the drill press can be used
        {
            id = 'ice_drill_lake_isabella',
            coords = {
                vector2(-1774.36, 639.42),
                vector2(-1785.91, 633.06),
                vector2(-1793.67, 645.12),
                vector2(-1782.03, 651.38)
            },
            minZ = 100.0,
            maxZ = 108.0,
        }
