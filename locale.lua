...
local Translations = {
    en = {
        ...
        ['error.invalid_water_body'] = 'You cannot wash stones in this water.',
        ['error.washing_no_dirty_stone'] = 'You do not have a dirty stone.',
        ['error.no_pickaxe'] = 'You do not have a pickaxe.',
        ['error.pickaxe_broken'] = 'Your pickaxe needs repairs before you can mine.',
        ['error.no_drill_tool'] = 'You need a working drill to operate this rig.',
        ['error.drill_tool_broken'] = 'Your drill is too damaged to use.',
        ['washing.no_valuable_resources'] = 'No valuable resources found.',
        ['washing.received_gem'] = 'Received: %dx %s',
        ['washing.countdown_label'] = 'Washing stone: %ds',
        ['washing.progress_label'] = 'Washing the dirty stone',
        ['mining.target_label'] = 'Start mining',
        ['mining.received_rock'] = 'You mined %dx %s.',
        ['mining.found_pyrite'] = 'You found %dx %s!',
        ['mining.found_shiny_ore'] = 'You uncovered %dx %s!',
        ...
        ['ice_drill.ice_reward'] = 'You collected %dx %s.',
        ['ice_drill.found_shiny_ore'] = 'You drilled up %dx %s!',
        ['ice_drill.fish_caught'] = 'Caught %dx %s while drilling!',
        ['ice_drill.durability'] = 'Drill durability: %d/%d',
        ['ice_drill.tool_durability'] = 'Drill tool condition: %d/%d',
        ['ice_drill.tool_broken'] = 'Your drill has broken!',
        ['ice_drill.replacement_received'] = 'Received: %s',
    ...
    pl = {
        ...
        ['error.invalid_water_body'] = 'Nie możesz płukać kamieni w tej wodzie.',
        ['error.washing_no_dirty_stone'] = 'Nie masz zabrudzonego kamienia.',
        ['error.no_pickaxe'] = 'Nie masz kilofa.',
        ['error.pickaxe_broken'] = 'Twój kilof wymaga naprawy zanim zaczniesz kopać.',
        ['error.no_drill_tool'] = 'Potrzebujesz sprawnego wiertła, aby obsłużyć tę maszynę.',
        ['error.drill_tool_broken'] = 'Twoje wiertło jest zbyt uszkodzone, by go użyć.',
        ['washing.no_valuable_resources'] = 'Nie znaleziono żadnych cennych surowców.',
        ['washing.received_gem'] = 'Otrzymano: %dx %s',
        ['washing.countdown_label'] = 'Mycie kamienia: %ds',
        ['washing.progress_label'] = 'Mycie zabrudzonego kamienia',
        ['mining.target_label'] = 'Rozpocznij kopanie',
        ['mining.received_rock'] = 'Wykopałeś %dx %s.',
        ['mining.found_pyrite'] = 'Znalazłeś %dx %s!',
        ['mining.found_shiny_ore'] = 'Wydobyłeś %dx %s!',
        ...
        ['ice_drill.ice_reward'] = 'Zebrałeś %dx %s.',
        ['ice_drill.found_shiny_ore'] = 'Wywierciłeś %dx %s!',
        ['ice_drill.fish_caught'] = 'Złapałeś %dx %s podczas wiercenia!',
        ['ice_drill.durability'] = 'Wytrzymałość wiertła: %d/%d',
        ['ice_drill.tool_durability'] = 'Stan wiertła: %d/%d',
        ['ice_drill.tool_broken'] = 'Twoje wiertło się zepsuło!',
        ['ice_drill.replacement_received'] = 'Otrzymano: %s',
