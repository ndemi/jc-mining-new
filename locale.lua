...
local Translations = {
    en = {
        ...
        ['ice_drill.found_shiny_ore'] = 'You drilled up a dirty stone!',
        ['ice_drill.fish_caught'] = 'Caught a %s while drilling!',
    ...
    pl = {
        ...
        ['ice_drill.found_shiny_ore'] = 'Udało ci się wywiercić zabrudzony kamień!',
        ['ice_drill.fish_caught'] = 'Złapałeś rybę: %s podczas wiercenia!',
